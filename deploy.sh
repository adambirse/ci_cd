...
cp ci_cd_deployment_template.yml ci_cd_deployment.yml

sed -i.bak "s/_PROJECT_NAME_/$PROJECT_NAME/g" ci_cd_deployment.yml
sed -i.bak "s/_DOCKER_IMAGE_NAME_/$DOCKER_IMAGE_NAME/g" ci_cd_deployment.yml
sed -i.bak "s/_TRAVIS_COMMIT_/$TRAVIS_COMMIT/g" ci_cd_deployment.yml
...
kubectl apply -f ci_cd_deployment.yml
